...
- [Generate Parentheses](https://github.com/ggcr/go-algorithms/tree/master/Stack/generate-parentheses) ([Leetcode 22](https://leetcode.com/problems/generate-parentheses)): Tricky one, O(N) solution with Backtracking algorithm with a Stack to help keep track of the state. Recursion in Go is more strict than any other languages, we do not want memory leaks!
