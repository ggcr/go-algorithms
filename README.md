...
- [Longest Consecutive Sequence](https://github.com/ggcr/go-algorithms/tree/master/longest-consecutive-sequence) ([Leetcode 128](https://leetcode.com/problems/longest-consecutive-sequence/)): O(N logN) solution: first we build up the hashset, then we count steaks above and below (value+1 and value-1).
### Two Pointers
...
- [Two Sum II](https://github.com/ggcr/go-algorithms/tree/master/two-sum-2) ([Leetcode 167](https://leetcode.com/problems/two-sum-ii-input-array-sorted)): O(N) solution, because the array is sorted we don't need the hashmap approach.
